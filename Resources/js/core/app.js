(() => {
  ...
  const ui = {
      state: null, adding: false, addingContext: null, moving: false, movingSeat: false, changes: [], compareUnits: [], selectedCompareUnitIds: new Set(), touchedSeats: new Set(), messageTimer: null, busyAction: null, busyTimer: null, disabledControls: new Map(), contextPoint: null, contextMenuRestoreFocus: null, undoPayload: null, pendingSeatId: null, pendingMapId: null, pendingAreaFocusId: null, pendingClusterId: null, clusterDraft: null, cardEdit: null, cardMove: null, cardSizeUndo: null, assignmentBaseline: null, pendingWarning: null, bulkConfirmation: null,
  ...
  function captureFocusRestorer(opener = document.activeElement) { return () => { if (opener?.isConnected) opener.focus({ preventScroll: true }); }; }
