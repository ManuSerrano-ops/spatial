(() => {
  ...
  const ui = {
      state: null, adding: false, addingContext: null, moving: false, movingSeat: false, changes: [], compareUnits: [], selectedCompareUnitIds: new Set(), touchedSeats: new Set(), messageTimer: null, busyAction: null, busyTimer: null, disabledControls: new Map(), contextPoint: null, contextMenuOpener: null, undoPayload: null, pendingSeatId: null, pendingMapId: null, pendingAreaFocusId: null, pendingClusterId: null, clusterDraft: null, cardEdit: null, cardMove: null, cardSizeUndo: null, assignmentBaseline: null, pendingWarning: null, bulkConfirmation: null,
  ...
  function hideContextMenu({ restoreFocus = true } = {}) { const menu = $('context-menu'); const opener = ui.contextMenuOpener; menu.classList.remove('show'); menu.removeAttribute('data-map-id'); menu.removeAttribute('data-area-id'); ui.contextMenuOpener = null; if (restoreFocus && opener?.isConnected) opener.focus({ preventScroll: true }); }
