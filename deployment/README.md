...
El generador publica la aplicación y crea un paquete con el EXE, avisos legales y una semilla de datos tomada de `runtime-data/data`. No incluye fuentes, pruebas, `bin`, `obj`, `publish`, backups ni logs.
