...
- [ ] **P3 · El destino de Mover no es operable íntegramente con teclado.** La acción Mover es alcanzable desde la ficha abierta por pin o lista, pero su coordenada final se escoge haciendo clic sobre el plano. Diseñar una alternativa de posicionamiento por teclado en una tarea dedicada.
